...
CAOS.commands = {
    ...
    ["command"] = {
      ...
      callback =
        function(self, attributes)
          ...
          -- ACTIVATEABLE
          if ( self.target.setInteractive ~= nil ) then
            self.target.setInteractive( bit32.band(attributes, CAOS.ATTRIBUTES.ACTIVATEABLE) ~= 0 )
          end
          ...
          -- INVISIBLE
          if ( self.target.setVisible ~= nil ) then
            self.target.setVisible( bit32.band(attributes, CAOS.ATTRIBUTES.INVISIBLE) ~= 0 )
          end
          ...
          -- SUFFER_PHYSICS
          if ( self.target.setGravityEnabled ~= nil ) then
            self.target.setGravityEnabled( bit32.band(attributes, CAOS.ATTRIBUTES.SUFFER_PHYSICS) ~= 0 )
          end
    ...
    ["command"] = {
      ...
      callback =
        function(self, on_off)
          ...
          elseif ( self.owner.setFacingDirection ~= nil ) then
            local direction = (on_off == 0) and 1 or -1
            self.owner.setFacingDirection(direction)
          end
        end
    },
  ...
  ["TICK"] = {
    ...
    ["integer"] = {
      ...
      callback =
        function(self)
          return self.timer_interval or 0
        end
    }
  },
      ...
      callback =
        function(self, room_id, ca_index )
          ...
          if ( ca_index == CAOS.CA_INDEX.SOUND ) then
            return world.windLevel(self.owner.position())
          elseif ( ca_index == CAOS.CA_INDEX.LIGHT ) then
            return world.lightLevel(self.owner.position())
          elseif ( ca_index == CAOS.CA_INDEX.HEAT ) then
            return world.temperature(self.owner.position())
  ...
  ["FALL"] = {
    ...
    callback =
      function(self)
        ...
        if ( self.target.falling ~= nil ) then
          return self.target.falling() and 1 or 0
        elseif ( self.target.velocity ~= nil ) then
          return (self.target.velocity()[2] == 0) and 0 or 1
        end
        return 0
      end
    }
  ...
  ["PRT: OTOT"] = {
    ...
    callback =
      function(self)
        if ( self.owner.outboundNodeCount ~= nil ) then
          return self.owner.outboundNodeCount()
        end
        return 0
      end
    }
  ...
  ["BUZZ"] = {
    ...
    ["integer"] = {
      ...
      callback =
        function(self)
          return self.update_interval or 50
        end
    }
  },
  ...
  ["OV00"] = { ["variable"] = { command = "OV00", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV01"] = { ["variable"] = { command = "OV01", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV02"] = { ["variable"] = { command = "OV02", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV03"] = { ["variable"] = { command = "OV03", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV04"] = { ["variable"] = { command = "OV04", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV05"] = { ["variable"] = { command = "OV05", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV06"] = { ["variable"] = { command = "OV06", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV07"] = { ["variable"] = { command = "OV07", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV08"] = { ["variable"] = { command = "OV08", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV09"] = { ["variable"] = { command = "OV09", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV10"] = { ["variable"] = { command = "OV10", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV11"] = { ["variable"] = { command = "OV11", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV12"] = { ["variable"] = { command = "OV12", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV13"] = { ["variable"] = { command = "OV13", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV14"] = { ["variable"] = { command = "OV14", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV15"] = { ["variable"] = { command = "OV15", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV16"] = { ["variable"] = { command = "OV16", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV17"] = { ["variable"] = { command = "OV17", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV18"] = { ["variable"] = { command = "OV18", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV19"] = { ["variable"] = { command = "OV19", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV20"] = { ["variable"] = { command = "OV20", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV21"] = { ["variable"] = { command = "OV21", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV22"] = { ["variable"] = { command = "OV22", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV23"] = { ["variable"] = { command = "OV23", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV24"] = { ["variable"] = { command = "OV24", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV25"] = { ["variable"] = { command = "OV25", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV26"] = { ["variable"] = { command = "OV26", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV27"] = { ["variable"] = { command = "OV27", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV28"] = { ["variable"] = { command = "OV28", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV29"] = { ["variable"] = { command = "OV29", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV30"] = { ["variable"] = { command = "OV30", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV31"] = { ["variable"] = { command = "OV31", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV32"] = { ["variable"] = { command = "OV32", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV33"] = { ["variable"] = { command = "OV33", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV34"] = { ["variable"] = { command = "OV34", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV35"] = { ["variable"] = { command = "OV35", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV36"] = { ["variable"] = { command = "OV36", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV37"] = { ["variable"] = { command = "OV37", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV38"] = { ["variable"] = { command = "OV38", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV39"] = { ["variable"] = { command = "OV39", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV40"] = { ["variable"] = { command = "OV40", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV41"] = { ["variable"] = { command = "OV41", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV42"] = { ["variable"] = { command = "OV42", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV43"] = { ["variable"] = { command = "OV43", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV44"] = { ["variable"] = { command = "OV44", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV45"] = { ["variable"] = { command = "OV45", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV46"] = { ["variable"] = { command = "OV46", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV47"] = { ["variable"] = { command = "OV47", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV48"] = { ["variable"] = { command = "OV48", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV49"] = { ["variable"] = { command = "OV49", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV50"] = { ["variable"] = { command = "OV50", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV51"] = { ["variable"] = { command = "OV51", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV52"] = { ["variable"] = { command = "OV52", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV53"] = { ["variable"] = { command = "OV53", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV54"] = { ["variable"] = { command = "OV54", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV55"] = { ["variable"] = { command = "OV55", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV56"] = { ["variable"] = { command = "OV56", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV57"] = { ["variable"] = { command = "OV57", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV58"] = { ["variable"] = { command = "OV58", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV59"] = { ["variable"] = { command = "OV59", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV60"] = { ["variable"] = { command = "OV60", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV61"] = { ["variable"] = { command = "OV61", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV62"] = { ["variable"] = { command = "OV62", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV63"] = { ["variable"] = { command = "OV63", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV64"] = { ["variable"] = { command = "OV64", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV65"] = { ["variable"] = { command = "OV65", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV66"] = { ["variable"] = { command = "OV66", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV67"] = { ["variable"] = { command = "OV67", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV68"] = { ["variable"] = { command = "OV68", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV69"] = { ["variable"] = { command = "OV69", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV70"] = { ["variable"] = { command = "OV70", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV71"] = { ["variable"] = { command = "OV71", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV72"] = { ["variable"] = { command = "OV72", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV73"] = { ["variable"] = { command = "OV73", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV74"] = { ["variable"] = { command = "OV74", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV75"] = { ["variable"] = { command = "OV75", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV76"] = { ["variable"] = { command = "OV76", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV77"] = { ["variable"] = { command = "OV77", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV78"] = { ["variable"] = { command = "OV78", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV79"] = { ["variable"] = { command = "OV79", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV80"] = { ["variable"] = { command = "OV80", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV81"] = { ["variable"] = { command = "OV81", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV82"] = { ["variable"] = { command = "OV82", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV83"] = { ["variable"] = { command = "OV83", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV84"] = { ["variable"] = { command = "OV84", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV85"] = { ["variable"] = { command = "OV85", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV86"] = { ["variable"] = { command = "OV86", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV87"] = { ["variable"] = { command = "OV87", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV88"] = { ["variable"] = { command = "OV88", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV89"] = { ["variable"] = { command = "OV89", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV90"] = { ["variable"] = { command = "OV90", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV91"] = { ["variable"] = { command = "OV91", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV92"] = { ["variable"] = { command = "OV92", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV93"] = { ["variable"] = { command = "OV93", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV94"] = { ["variable"] = { command = "OV94", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV95"] = { ["variable"] = { command = "OV95", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV96"] = { ["variable"] = { command = "OV96", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV97"] = { ["variable"] = { command = "OV97", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV98"] = { ["variable"] = { command = "OV98", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ["OV99"] = { ["variable"] = { command = "OV99", rtype = "variable", params = {}, description = [[OV00 to OV99 are variables specific to an agent.  They are read from @TARG@, the target agent.  You can also access these same variables via owner using @MVxx@.]], callback = function(self) return nil end } },
  ...
  ["VA00"] = {["variable"] = { command = "VA00", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA01"] = {["variable"] = { command = "VA01", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA02"] = {["variable"] = { command = "VA02", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA03"] = {["variable"] = { command = "VA03", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA04"] = {["variable"] = { command = "VA04", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA05"] = {["variable"] = { command = "VA05", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA06"] = {["variable"] = { command = "VA06", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA07"] = {["variable"] = { command = "VA07", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA08"] = {["variable"] = { command = "VA08", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA09"] = {["variable"] = { command = "VA09", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA10"] = {["variable"] = { command = "VA10", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA11"] = {["variable"] = { command = "VA11", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA12"] = {["variable"] = { command = "VA12", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA13"] = {["variable"] = { command = "VA13", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA14"] = {["variable"] = { command = "VA14", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA15"] = {["variable"] = { command = "VA15", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA16"] = {["variable"] = { command = "VA16", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA17"] = {["variable"] = { command = "VA17", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA18"] = {["variable"] = { command = "VA18", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA19"] = {["variable"] = { command = "VA19", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA20"] = {["variable"] = { command = "VA20", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA21"] = {["variable"] = { command = "VA21", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA22"] = {["variable"] = { command = "VA22", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA23"] = {["variable"] = { command = "VA23", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA24"] = {["variable"] = { command = "VA24", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA25"] = {["variable"] = { command = "VA25", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA26"] = {["variable"] = { command = "VA26", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA27"] = {["variable"] = { command = "VA27", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA28"] = {["variable"] = { command = "VA28", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA29"] = {["variable"] = { command = "VA29", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA30"] = {["variable"] = { command = "VA30", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA31"] = {["variable"] = { command = "VA31", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA32"] = {["variable"] = { command = "VA32", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA33"] = {["variable"] = { command = "VA33", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA34"] = {["variable"] = { command = "VA34", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA35"] = {["variable"] = { command = "VA35", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA36"] = {["variable"] = { command = "VA36", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA37"] = {["variable"] = { command = "VA37", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA38"] = {["variable"] = { command = "VA38", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA39"] = {["variable"] = { command = "VA39", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA40"] = {["variable"] = { command = "VA40", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA41"] = {["variable"] = { command = "VA41", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA42"] = {["variable"] = { command = "VA42", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA43"] = {["variable"] = { command = "VA43", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA44"] = {["variable"] = { command = "VA44", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA45"] = {["variable"] = { command = "VA45", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA46"] = {["variable"] = { command = "VA46", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA47"] = {["variable"] = { command = "VA47", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA48"] = {["variable"] = { command = "VA48", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA49"] = {["variable"] = { command = "VA49", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA50"] = {["variable"] = { command = "VA50", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA51"] = {["variable"] = { command = "VA51", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA52"] = {["variable"] = { command = "VA52", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA53"] = {["variable"] = { command = "VA53", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA54"] = {["variable"] = { command = "VA54", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA55"] = {["variable"] = { command = "VA55", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA56"] = {["variable"] = { command = "VA56", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA57"] = {["variable"] = { command = "VA57", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA58"] = {["variable"] = { command = "VA58", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA59"] = {["variable"] = { command = "VA59", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA60"] = {["variable"] = { command = "VA60", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA61"] = {["variable"] = { command = "VA61", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA62"] = {["variable"] = { command = "VA62", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA63"] = {["variable"] = { command = "VA63", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA64"] = {["variable"] = { command = "VA64", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA65"] = {["variable"] = { command = "VA65", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA66"] = {["variable"] = { command = "VA66", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA67"] = {["variable"] = { command = "VA67", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA68"] = {["variable"] = { command = "VA68", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA69"] = {["variable"] = { command = "VA69", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA70"] = {["variable"] = { command = "VA70", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA71"] = {["variable"] = { command = "VA71", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA72"] = {["variable"] = { command = "VA72", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA73"] = {["variable"] = { command = "VA73", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA74"] = {["variable"] = { command = "VA74", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA75"] = {["variable"] = { command = "VA75", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA76"] = {["variable"] = { command = "VA76", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA77"] = {["variable"] = { command = "VA77", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA78"] = {["variable"] = { command = "VA78", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA79"] = {["variable"] = { command = "VA79", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA80"] = {["variable"] = { command = "VA80", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA81"] = {["variable"] = { command = "VA81", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA82"] = {["variable"] = { command = "VA82", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA83"] = {["variable"] = { command = "VA83", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA84"] = {["variable"] = { command = "VA84", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA85"] = {["variable"] = { command = "VA85", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA86"] = {["variable"] = { command = "VA86", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA87"] = {["variable"] = { command = "VA87", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA88"] = {["variable"] = { command = "VA88", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA89"] = {["variable"] = { command = "VA89", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA90"] = {["variable"] = { command = "VA90", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA91"] = {["variable"] = { command = "VA91", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA92"] = {["variable"] = { command = "VA92", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA93"] = {["variable"] = { command = "VA93", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA94"] = {["variable"] = { command = "VA94", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA95"] = {["variable"] = { command = "VA95", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA96"] = {["variable"] = { command = "VA96", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA97"] = {["variable"] = { command = "VA97", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA98"] = {["variable"] = { command = "VA98", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
  ["VA99"] = {["variable"] = { command = "VA99", rtype = "variable", params = {}, description = [[VA00 to VA99 are local variables, whose values are lost when the current script ends.]], callback = function(self) return nil end }},
